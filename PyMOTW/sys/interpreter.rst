...
.. {{{cog
.. cog.out(run_script(cog.inFile, 'sys_version_values.py', interpreter='python2', break_lines_at=70))
.. cog.out(run_script(cog.inFile, 'sys_version_values.py', interpreter='python3', include_prefix=False, break_lines_at=70))
.. }}}

::

	$ python2 sys_version_values.py
	
	Version info:
	()
	('sys.version      =', "'2.7.6 (default, Jun 22 2015, 17:58:13) \\n[GC
	C 4.8.2]'")
	('sys.version_info =', sys.version_info(major=2, minor=7, micro=6, rel
	...
	sys.version      = '3.4.3 (default, Jul 28 2015, 18:20:59) \n[GCC 4.8.
	4]'
	sys.version_info = sys.version_info(major=3, minor=4, micro=3, release
